...
<div class="writing">
    ...
    <input type="hidden" id="tiempo-writing-used" value="<?= ($alumnoExamen->writing_used_time ? $alumnoExamen->writing_used_time : 0) ?>" />
    <section class="body-writing">
        <div class="container">
            <?php
                $pregunta = $writing->reactivosActivos();
                ...
                foreach($pregunta as $preg){
                    if($preg->status == 1){    ?>
                        ...
                        <?php $form = ActiveForm::begin(['id' => 'solve-writing-form', 'action' => 'save-writing']); ?>
                            ...
                            <?php echo Html::hiddenInput('WritingResueltoForm[reactivo]', $preg->id, ['id'=>'reactivo']); ?>
                            <div class="row">
