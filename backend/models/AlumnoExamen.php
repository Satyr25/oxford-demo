...
class AlumnoExamen extends \yii\db\ActiveRecord
{
    ...
    public $calificacionUse;
    public $calificacionReading;
    public $calificacionListening;
    public $calificacionWriting;
    public $calificacionSpeaking;
    public $promedio_use;
    public $promedio_reading;
    public $promedio_listening;
    public $promedio_writing;
    public $promedio;
    public $nivel;
    public $codigo;
    public $grupo;
    ...
    public function cerrado($tipo_examen, $alumno){
        return $this->find()
            ->where('alumno_id = '.$alumno.' AND tipo_examen_id = '.$tipo_examen.' AND inactivity = 1')
            ->all();
    }

    public function porNivelAlumno($nivel,$alumno,$tipo){
        return $this->find()
