...
<table style="width: 600px;">
	...
	<tr>
		<td style="padding:60px; text-align: justify; background-color: #fff; font-family: 'Karla'; font-size: 19px;">
			...
			<br>
			<br>
				<?php if ($examType->clave == "DIA"): ?>
					Here are the results from the diagnostic exam that you recently took with us. The levels that you see here are what we suggest each student should continue with for the next step of The Oxford TCC process
					<?php if ($instituto->programa->clave == "CLI"): ?>
					(the mock test)
					<?php endif; ?>
					.
				<?php elseif ($examType->clave == "CER"): ?>
					Here are the results from the Certificate exam that you recently took with us.
				<?php endif; ?>
			<br>
